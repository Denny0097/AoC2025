...
class EyerissMapper:
    ...
    def generate_mappings(self, verbose: bool = False) -> list[EyerissMappingParam]:
        ...
        # r_available_list = [1]
        # t_available_list = [2]
        # m_available_list = [16, 32, 64, 128, 256]

        if verbose:
            print(
                f"m: {m_available_list}\n"
                f"n: {n_avaliable_list}\n"
                f"e: {e_available_list}\n"
                f"p: {p_available_list}\n"
                f"q: {q_available_list}\n"
                f"r: {r_available_list}\n"
                f"t: {t_available_list}\n"
            )

        candidate_tuples = product(
            m_available_list,
            n_avaliable_list,
            e_available_list,
            p_available_list,
        ...
        candidate_solutions = [
            ...
            for m, n, e, p, q, r, t in candidate_tuples
        ]
